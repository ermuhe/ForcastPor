 ...
 * @throws NumberFormatException 
   ...
   public static void main(String[] args) throws NumberFormatException, ParseException {
      ...
      // TODO Auto-generated method stub
       ...
       cluster.readData("C:/Users/dell/Desktop/云南网优/counter.txt");
       ...
       cluster.printResult("C:/Users/dell/Desktop/云南网优/result.txt");
   ...
   public void readData(String trainingFileName) throws NumberFormatException, ParseException
...
//              System.out.println(splitData[i].getClass());
                ...
                {   //将数据截取之后放进数组
                   ...
                   data[line][i] = Float.parseFloat(date.parse(splitData[i]).getTime()+"");
